...
CREATE TABLE IF NOT EXISTS fence_specs (
    ...
    CONSTRAINT fence_specs_height_positive CHECK (height_feet > 0),
...
CREATE TABLE IF NOT EXISTS estimates (
    ...
    CONSTRAINT estimates_markup_pct_check CHECK (markup_pct >= 0),
...
CREATE TABLE IF NOT EXISTS inventory (
    ...
    CONSTRAINT inventory_unit_cost_nonnegative CHECK (unit_cost >= 0),
