...
'use strict';
/**
 * Gate configuration tab helpers for single and double gates, walk and drive gates, hardware options, and pricing.
 * @module tab07Gates
 */
...
function parseStoredValue() {
    ...
    catch (error) { console.warn('gates storage parse failed.', error); return {}; }
}
...
function render(root, elements, state) {
    ...
    if (total) { total.textContent = asCurrency(state.gateTotal); }
...
const api = { init: initTab07Gates, initTab07Gates: initTab07Gates };
