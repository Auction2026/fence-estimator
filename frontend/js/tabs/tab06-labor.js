...
'use strict';
/**
 * Labor tab helpers for crew size, estimated days, setup time, labor breakdowns, and total labor cost.
 * @module tab06Labor
 */
...
function parseStoredValue() {
    ...
    catch (error) { console.warn('labor storage parse failed.', error); return {}; }
}
...
function render(root, elements, state) {
    ...
    if (total) { total.textContent = asCurrency(state.laborTotal); }
...
const api = { init: initTab06Labor, initTab06Labor: initTab06Labor };
