...
/**
 * Customer information tab helpers for contact capture, light auto-fill, validation hooks, and customer saves.
...
function parseStoredValue() {
    try {
        ...
        console.warn('customer storage parse failed.', error);
        return {};
    }
}
...
function applySavedCustomer(root, state) {
    ...
    const merged = Object.assign({}, state, active);
    hydrate(root, merged);
}

const api = {
    init: initTab01Customer,
    initTab01Customer: initTab01Customer
};
