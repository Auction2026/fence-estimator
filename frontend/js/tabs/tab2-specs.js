...
(() => {
  ...
  function updateSummary(ctx) {
    const values = readValues();
    if (TAB_ID === 'project') {
      ctx.ui.renderSummaryList('project-summary', [['fenceType', values['fenceType'] || ''], ['height', values['height'] || ''], ['linearFeet', values['linearFeet'] || ''], ['numberOfPosts', values['numberOfPosts'] || '']]);
    }
  }
