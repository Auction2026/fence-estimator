...
(() => {
  ...
  function updateSummary(ctx) {
    const values = readValues();
    if (TAB_ID === 'project') {
      ctx.ui.renderSummaryList('project-summary', [['layoutReference', values['layoutReference'] || ''], ['layoutObstacles', values['layoutObstacles'] || ''], ['layoutAccess', values['layoutAccess'] || '']]);
    }
  }
