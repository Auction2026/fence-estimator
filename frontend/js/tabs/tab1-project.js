...
(() => {
  ...
  function updateSummary(ctx) {
    const values = readValues();
    if (TAB_ID === 'project') {
      ctx.ui.renderSummaryList('project-summary', [['customerName', values['customerName'] || ''], ['customerEmail', values['customerEmail'] || ''], ['customerPhone', values['customerPhone'] || ''], ['address', values['address'] || ''], ['projectNumber', values['projectNumber'] || '']]);
    }
  }
